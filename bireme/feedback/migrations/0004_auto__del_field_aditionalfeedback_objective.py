...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('feedback_aditionalfeedback', 'objective_id')


    def backwards(self, orm):
        
        # Adding field 'AditionalFeedback.objective'
        db.add_column('feedback_aditionalfeedback', 'objective', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feedback.Objective'], null=True, blank=True), keep_default=False)


    models = {
        'application.application': {
            'Meta': {'object_name': 'Application'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 2, 16, 45, 4, 16007)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 2, 16, 45, 4, 16043)'}),
