...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Feedback.hash'
        db.delete_column('feedback_feedback', 'hash')


    def backwards(self, orm):
        
        # Adding field 'Feedback.hash'
        db.add_column('feedback_feedback', 'hash', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)


    models = {
        'application.application': {
            'Meta': {'object_name': 'Application'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 18, 20, 5, 247387)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 18, 20, 5, 247424)'}),
